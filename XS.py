class XStandart :
    while True :
        ...
        linkler = ('wp-admin/','cpanel/','admin/','administrator/','login.php','administration/','admin1/','admin2/','admin3/','admin4/','admin5/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
        ...
        for hedef in linkler :
            panel = url+hedef
            try :
                url_ac = urllib.request.urlopen(panel)
                print(Fore.LIGHTGREEN_EX + "BULUNDU  "+panel)
            except urllib.error.URLError as ueU :
                print(Fore.RED + "BULUNAMADI :  "+panel)

            except ValueError :
                print(Fore.RED + "Hatalı İşlem Yaptınız")
                time.sleep(1)
                Clear.Clear()
                break
